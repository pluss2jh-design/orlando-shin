                ...
                <div className="xl:col-span-2 space-y-8">
                    <Card className="bg-gray-900 border-gray-800 overflow-hidden shadow-2xl">
                        ...
                        <div className="p-6 border-t border-gray-800 bg-gray-900/80">
                            ...
                            {isRequesting ? (
                                <Button disabled className="w-full h-14 bg-blue-600/50 text-white text-lg font-black shadow-lg">
                                    <RefreshCw className="h-5 w-5 mr-3 animate-spin text-white" /> AI 엔진에 학습 요청 중... (잠시만 기다려주세요)
                                </Button>
                            ) : learning ? (
